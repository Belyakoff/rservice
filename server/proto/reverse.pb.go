...
var file_proto_reverse_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x3c, 0x0a, 0x07,
	0x52, 0x65, 0x76, 0x65, 0x72, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x02, 0x44, 0x6f, 0x12, 0x13, 0x2e,
	0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x14, 0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
...
var file_proto_reverse_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: main.proto.Request
	(*Response)(nil), // 1: main.proto.Response
}
var file_proto_reverse_proto_depIdxs = []int32{
	0, // 0: main.proto.Reverse.Do:input_type -> main.proto.Request
	1, // 1: main.proto.Reverse.Do:output_type -> main.proto.Response
...
func (c *reverseClient) Do(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/main.proto.Reverse/Do", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Reverse_Do_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.proto.Reverse/Do",
	}
...
var _Reverse_serviceDesc = grpc.ServiceDesc{
	ServiceName: "main.proto.Reverse",

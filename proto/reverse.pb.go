...
func init() {
	proto.RegisterType((*Request)(nil), "rservice.Request")
	proto.RegisterType((*Response)(nil), "rservice.Response")
}
...
var fileDescriptor_142d12653d52cef8 = []byte{
	...
	0x2d, 0x2a, 0x4e, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x28, 0x2a, 0x4e, 0x2d, 0x2a,
	0xcb, 0x4c, 0x4e, 0x55, 0x52, 0xe6, 0x62, 0x0f, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0x11, 0x92,
	...
	0x32, 0xb2, 0x00, 0x19, 0x05, 0xb6, 0x45, 0x48, 0x97, 0x8b, 0xc9, 0x25, 0x5f, 0x48, 0x50, 0x0f,
	0x66, 0x8d, 0x1e, 0xd4, 0x0e, 0x29, 0x21, 0x64, 0x21, 0x88, 0x89, 0x4a, 0x0c, 0x49, 0x6c, 0x60,
	0x57, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x82, 0x8d, 0x7a, 0xc5, 0xa6, 0x00, 0x00, 0x00,
}
...
func (c *reverseClient) Do(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/rservice.Reverse/Do", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Reverse_Do_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rservice.Reverse/Do",
	}
